    ...
    export default function AddNewTodo() {
        ...
        return(
            <div className="">
                <div>
                    <label>
                    <input type="text" className="font-normal border border-slate-300 rounded-full py-1 pl-4 pr-4 shadow-md focus:outline-blue-500        placeholder:italic placeholder:text-slate-400 " placeholder= "Enter your task to do..."
